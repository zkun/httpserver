...
extern const int cPeriodDurationMSec;
}
...
public:
    ...
    bool isRequestWithinRate(const QHostAddress &peerAddress);
    bool isRequestWithinRate(const QHostAddress &peerAddress, qint64 currTimeMSec);
